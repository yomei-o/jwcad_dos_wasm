...
undefined4 __stdcall16far FUN_32b2_4e44(uint param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  if (param_4 == 0) {
    ...
    iVar6 = 0;
    if ((int)(uVar11 - 1) < 0) goto LAB_32b2_4ede;
  }
  else {
    do {
      uVar10 = uVar9 >> 1;
    ...
    if (-1 < (int)(uVar11 - 1)) goto LAB_32b2_4ede;
  }
  bVar13 = iVar5 != 0;
  iVar5 = -iVar5;
