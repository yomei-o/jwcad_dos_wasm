...
uint * __cdecl16near FUN_32b2_1fac(void)
    ...
    while( true ) {
      ...
      if ((uVar3 & 1) != 0) {
        while( true ) {
          ...
          if (CARRY2((uint)puVar1,uVar2)) goto LAB_32b2_2005;
      ...
      if (((uint)puVar5 & 1) != 0) goto LAB_32b2_2005;
      puVar7 = (uint *)*(undefined2 *)(in_BX + 6);
      if ((uint *)*(undefined2 *)(in_BX + 8) == puVar7) goto LAB_32b2_2005;
