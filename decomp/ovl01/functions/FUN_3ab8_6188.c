...
code_r0x00040d08:
  do {
    if ((((*(int *)(unaff_BP + -0x1fe) == 1) || (*(int *)(unaff_BP + -0x1fe) == 3)) ||
        (*(int *)(unaff_BP + -0x1fe) == 4)) || (iVar16 = iVar9, *(int *)(unaff_BP + -0x1fe) == 6)) {
    ...
    do {
      if (*(int *)(unaff_BP + -0x1fe) == 4) {
        ...
        *(undefined2 *)(unaff_BP + -0x262) = uVar10;
          ...
          do {
            do {
              ...
              *(undefined2 *)(unaff_BP + -0x1d6) = uVar5;
              ...
              iVar15 = unaff_BP + -0x58;
              func_0x000297e6(0x22b2,iVar15,iVar23,unaff_BP + -0x21e,unaff_BP + -0x232,iVar24,iVar9,
        ...
        uVar10 = 0x12bb;
        func_0x00029d78(0x22b2);
        func_0x000299d1(0x22b2,iVar24,iVar9,uVar10);
        func_0x000297e6(0x22b2);
        uVar10 = 0x12d3;
        func_0x00029d78(0x22b2);
        iVar16 = 0x22b2;
        func_0x000299d1(0x22b2,iVar15,iVar23,uVar10);
      ...
      *(undefined2 *)(unaff_BP + -0x210) = *(undefined2 *)0x152;
      ...
      if ((*(char *)0xb1ea == '\0') || (*(char *)0xb1ea == '\x03')) {
        ...
        *(undefined2 *)(unaff_BP + -0x162) = uVar10;
        *(undefined2 *)(unaff_BP + -0x10c) = *(undefined2 *)0x150;
        uVar10 = *(undefined2 *)0x152;
        *(undefined2 *)(unaff_BP + -0x210) = uVar10;
        if (*(char *)0x22b0 != '\0') {
          iVar9 = FUN_4375_76b1();
          uVar10 = 0;
          if (iVar9 != 0) {
        ...
        uStack_6 = CONCAT11((char)((uint)uVar10 >> 8),*(undefined1 *)0x22b0);
          ...
          *(undefined1 *)(unaff_BP + -0x1cc) = 0;
          if (*(char *)(unaff_BP + -0x134) == '\0') {
            if ((((*(int *)(unaff_BP + -0x1fe) == 1) || (*(int *)(unaff_BP + -0x1fe) == 3)) ||
               ...
               (iVar9 = iVar15, *(int *)(unaff_BP + -0x1fe) == 6)) {
              *(undefined2 *)0xc20 = 1;
              uStack_6 = 0x2258;
              iStack_8 = unaff_BP + -0x1cc;
              iVar9 = 0x22b2;
...
LAB_3ab8_6f8b:
      ...
      if (*(int *)(unaff_BP + -0x1f0) == 2) {
        ...
        if ((((*(char *)0x15a == '\0') && (0x20 < *(int *)(unaff_BP + -0x268))) &&
            (*(char *)0x124 != '\0')) && ((*(char *)0xb1ea == '\0' || (*(char *)0xb1ea == '\x03'))))
        {
          *(undefined2 *)0xc22 = 1;
          uStack_6 = 2;
          iStack_8 = 0x14;
          ...
          *(undefined2 *)(unaff_BP + -0x262) = 0;
          while( true ) {
            ...
            if ((*(int *)0x14a < iVar9) ||
               ((*(int *)0x14a <= iVar9 && (*(uint *)0x148 < *(uint *)(unaff_BP + -0x264))))) break;
            uStack_6 = uVar10;
            ...
            uVar11 = *puVar2;
            *puVar2 = *puVar2 + 1;
            *(int *)(unaff_BP + -0x262) = *(int *)(unaff_BP + -0x262) + (uint)(0xfffe < uVar11);
          }
          *(undefined2 *)(unaff_BP + -0x264) = 1;
          *(undefined2 *)(unaff_BP + -0x262) = 0;
          while( true ) {
            iVar9 = *(int *)(unaff_BP + -0x262);
            if ((*(int *)0x14e < iVar9) ||
               ((*(int *)0x14e <= iVar9 && (*(uint *)0x14c < *(uint *)(unaff_BP + -0x264))))) break;
            uStack_6 = uVar10;
      ...
      *(undefined2 *)(unaff_BP + -0xca) = *(undefined2 *)0x150;
      ...
      do {
        ...
        *(uint *)(unaff_BP + -0x220) = (uint)bVar7;
        ...
        uStack_1e = *(undefined2 *)(unaff_BP + -0x1e6);
        iStack_20 = unaff_BP + -0xca;
        func_0x000297e6(0x22b2,unaff_BP + -0x58,unaff_BP + -0x92,unaff_BP + -0x21e,unaff_BP + -0x232
                        ,unaff_BP + -0x146,unaff_BP + -0x5c,unaff_BP + -0x226,unaff_BP + -0x1e0,
                        unaff_BP + -0x1e4,unaff_BP + -0x132);
        func_0x00029d78(0x22b2);
        func_0x000299d1(0x22b2);
        func_0x000297e6(0x22b2);
        func_0x00029d78(0x22b2);
                ...
                do {
                  do {
                    ...
                    *(undefined2 *)0xc20 = 0;
                    ...
                    if (iVar16 == -1) goto LAB_3ab8_576c;
                  } while (*(int *)(unaff_BP + -0x146) == 0);
                  uStack_6 = *(int *)(unaff_BP + -0x146);
                  iStack_8 = 0x1bb4;
                  iVar9 = 0x11f2;
...
LAB_3ab8_59bb:
    ...
    if ((*(int *)(unaff_BP + -0x92) < *(int *)0xa5e) && (*(int *)(unaff_BP + -0x146) != 0)) {
      *(undefined2 *)(unaff_BP + -0x146) = 0;
      ...
      if ((((int)(((*(uint *)0xc1c ^ uVar11) - uVar11) + *(int *)0xa5e) < *(int *)(unaff_BP + -0x92)
           ) && (*(char *)0x124 != '\0')) && (*(int *)(unaff_BP + -0x124) != 0)) {
