...
まだ無いのは 変形（17）の残り 3 つ（②包絡処理変形・④線記号変形・⑤外部）、曲線（23）の残り 4 つ（①ｻｲﾝ曲線・③ｽﾌﾟﾗｲﾝ・⑧解除 は入りました）、
寸法の ②円周 の ②連続始点指示、
...
19. ~~寸法（14）~~ ほぼ済 — ①横方向・②縦方向・③任意方向・⑤寸法値・⑥点・
    ...
    ②円周 の ②連続始点指示 だけ
20. **残りを 1 つずつ** —— 変形（17）、曲線（23）の残り 4 つ（①ｻｲﾝ曲線・③ｽﾌﾟﾗｲﾝ・⑧解除 は入りました）、円線接（26）の
    残りの枝、帯の 電卓・範囲記憶・ｵﾌｾｯﾄ・HELP、ｵﾌﾟｼｮﾝ（29）の大きいところ
