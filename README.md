...
**寸法（14）はひととおり**——①横方向・②縦方向・③任意方向・⑤寸法値・⑥点・
⑦矢印・⑨設定、それに 小数点以下の桁・累寸・連続入力。⑨設定 の値
（ペン・離れ・突出・矢印の長さと角度・単位・桁・(,)・0 表示）は
**図の描かれ方にそのまま効きます**。
...
まだ無いのは **変形（17）**、曲線（23）の残り 7 つ、円線接（26）の残りの枝、
寸法の ④円･角・⑧値変・②半径・③直径・⑤一括、帯の 電卓・範囲記憶・ｵﾌｾｯﾄ・HELP、
