...
sh tools/cc.sh -O2 -Wall -Wextra -Isrc -Itests -o tests/drawing.exe tests/drawing.c tests/png.c src/vga.c src/draw.c src/jwc.c src/view.c -lm
echo "built tests/vga_test.exe tests/draw_test.exe tests/jwc_test.exe tests/screen.exe tests/drawing.exe"
