...
static const JwStage JW_TYPED[] = {
    ...
    /* 16 移動 ⑥回転 -- 段 13 to 16, the same numbers 複写 uses. */
    { 16, 13,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]" },
    { 16, 13,  8, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x88" "\xda" "\x93" "\xae" "  \x8c" "\xb4" "\x90" "}\x8c" "`\x82" "\xcc" "\x8a" "\xee" "\x8f" "\x80" "\x93" "_\x88" "\xca" "\x92" "u \x83" "}\x83" "E\x83" "X\x8e" "w\x8e" "\xa6" " (L)free (R)Read  |\x87" "@\x81" "y\x94" "C\x88" "\xd3" "\x81" "z\x95" "\xfb" "\x8c" "\xfc" "|" },
    { 16, 14,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]  " },
    { 16, 14,  8, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x8a" "p\x93" "x =" },
    { 16, 14, 32, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x81" "b0 \x93" "x \xcf" "\xb3" "\xbd" "(L)\x81" "b\x91" "O\x89" "\xf1" "\x82" "\xc6" "\x93" "\xaf" "\x82" "\xb6" " \xcf" "\xb3" "\xbd" "(R) \x81" "b[F1] \xcf" "\xb3" "\xbd" "\x8a" "p\x93" "x\x81" "b" },
    { 16, 14, 50, 2, 7, 0xffff, 0, 0, { 0, 0 }, 0, "[  45.000\xdf" "]" },
    { 16, 14, 15, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "        " },
    { 16, 15, 71, 2, 7, 0xffff, 0, 0, { 0, 0 }, 0, "  30.000\xdf" },
    { 16, 15,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]  \x88" "\xda" "\x93" "\xae" " \x88" "\xca" "\x92" "u \x83" "}\x83" "E\x83" "X\x8e" "w\x8e" "\xa6" " (L)free (R)Read  |\x87" "@\x81" "y\x94" "C\x88" "\xd3" "\x81" "z\x95" "\xfb" "\x8c" "\xfc" "|\x87" "A\x89" "\xbc" "\x95" "\\\x8e" "\xa6" "|\x87" "B\x89" "\xf1" "\x93" "]\x8a" "p|" },
    { 16, 16,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]" },
    { 16, 16,  6, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x81" "E" },
    { 16, 16,  8, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x8d" "\xc4" "\x88" "\xda" "\x93" "\xae" " \x88" "\xca" "\x92" "u\x8e" "w\x8e" "\xa6" "(L)free (R)Read |\x87" "@\x93" "\xaf" "\x8c" "`\x95" "\xca" "\x8f" "\x88" "\x97" "\x9d" "|\x87" "A\x91" "\xbc" "\x90" "}\x8c" "`\x8f" "\x88" "\x97" "\x9d" "|\x87" "B\x98" "A\x91" "\xb1" "|" },
    /* 16 移動 ③数値倍率 -- 段 17 to 20, the same numbers 複写 uses. */
    { 16, 17,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]" },
    { 16, 17,  8, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x88" "\xda" "\x93" "\xae" "  \x8c" "\xb4" "\x90" "}\x8c" "`\x82" "\xcc" "\x8a" "\xee" "\x8f" "\x80" "\x93" "_\x88" "\xca" "\x92" "u \x83" "}\x83" "E\x83" "X\x8e" "w\x8e" "\xa6" " (L)free (R)Read  |\x87" "@\x81" "y\x94" "C\x88" "\xd3" "\x81" "z\x95" "\xfb" "\x8c" "\xfc" "|" },
    { 16, 18,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC].\x94" "{\x97" "\xa6" " X,Y =" },
    { 16, 18, 38, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x91" "O\x89" "\xf1" "\x82" "\xc6" "\x93" "\xaf" "\x82" "\xb6" " \xcf" "\xb3" "\xbd" "(R) " },
    { 16, 18, 56, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[     2.000" },
    { 16, 18, 67, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, ",     2.000" },
    { 16, 18, 78, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "]" },
    { 16, 18, 18, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "        " },
    { 16, 19,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]  \x88" "\xda" "\x93" "\xae" " \x88" "\xca" "\x92" "u \x83" "}\x83" "E\x83" "X\x8e" "w\x8e" "\xa6" " (L)free (R)Read  |\x87" "@\x81" "y\x94" "C\x88" "\xd3" "\x81" "z\x95" "\xfb" "\x8c" "\xfc" "|\x87" "A\x89" "\xbc" "\x95" "\\\x8e" "\xa6" "|" },
    { 16, 20,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]" },
    { 16, 20,  6, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x81" "E" },
    { 16, 20,  8, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x8d" "\xc4" "\x88" "\xda" "\x93" "\xae" " \x88" "\xca" "\x92" "u\x8e" "w\x8e" "\xa6" "(L)free (R)Read |\x87" "@\x93" "\xaf" "\x8c" "`\x95" "\xca" "\x8f" "\x88" "\x97" "\x9d" "|\x87" "A\x91" "\xbc" "\x90" "}\x8c" "`\x8f" "\x88" "\x97" "\x9d" "|\x87" "B\x98" "A\x91" "\xb1" "|" },
    /* 16 移動 ④ﾏｳｽ倍率 -- 段 21 to 25, the same numbers 複写 uses. */
    { 16, 21,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]" },
    { 16, 21,  8, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x88" "\xda" "\x93" "\xae" "  \x8c" "\xb4" "\x90" "}\x8c" "`\x82" "\xcc" "\x8a" "\xee" "\x8f" "\x80" "\x93" "_\x88" "\xca" "\x92" "u \x83" "}\x83" "E\x83" "X\x8e" "w\x8e" "\xa6" " (L)free (R)Read  |\x87" "@\x81" "y\x94" "C\x88" "\xd3" "\x81" "z\x95" "\xfb" "\x8c" "\xfc" "|" },
    { 16, 22,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]" },
    { 16, 22,  8, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x8c" "\xb4" "\x90" "}\x8c" "`\x82" "\xcc" " \x83" "}\x83" "E\x83" "X\x94" "{\x97" "\xa6" " \x91" "\xce" "\x8a" "p\x88" "\xca" "\x92" "u  \x83" "}\x83" "E\x83" "X\x8e" "w\x8e" "\xa6" " (L)free (R)Read " },
    { 16, 23,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]  \x88" "\xda" "\x93" "\xae" " \x88" "\xca" "\x92" "u \x83" "}\x83" "E\x83" "X\x8e" "w\x8e" "\xa6" " (L)free (R)Read  |\x87" "@\x81" "y\x94" "C\x88" "\xd3" "\x81" "z\x95" "\xfb" "\x8c" "\xfc" "|\x87" "A\x89" "\xbc" "\x95" "\\\x8e" "\xa6" "|" },
    { 16, 24,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]  \x88" "\xda" "\x93" "\xae" "\x82" "\xcc" " \x83" "}\x83" "E\x83" "X\x94" "{\x97" "\xa6" " \x91" "\xce" "\x8a" "p\x88" "\xca" "\x92" "u  \x83" "}\x83" "E\x83" "X\x8e" "w\x8e" "\xa6" " (L)free (R)Read " },
    { 16, 25,  1, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "[ESC]" },
    { 16, 25,  6, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x81" "E" },
    { 16, 25,  8, 1, 7, 0x0000, 0, 0, { 0, 0 }, 0, "\x8d" "\xc4" "\x88" "\xda" "\x93" "\xae" " \x88" "\xca" "\x92" "u\x8e" "w\x8e" "\xa6" "(L)free (R)Read |\x87" "@\x93" "\xaf" "\x8c" "`\x95" "\xca" "\x8f" "\x88" "\x97" "\x9d" "|\x87" "A\x91" "\xbc" "\x90" "}\x8c" "`\x8f" "\x88" "\x97" "\x9d" "|\x87" "B\x98" "A\x91" "\xb1" "|" },
