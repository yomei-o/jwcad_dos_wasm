    ...
    if (s->zoom_stage) {
        ...
        for (i = 1; !s->top_item && !s->zukei && i <= s->stage; i++) {
            ...
            if (s->command == 26 && i == s->stage
                ...
                if (i == 50) {
                    jw_ui_text(v, 8, 1, 7, 0, "|\x87@ \x82R\x93_ |\x87" "A \x82Q\x93_\x82\xc6\x82P\x90\xfc\xa5\x89~ |\x87" "B \x82P\x93_\x82\xc6\x82Q\x90\xfc\xa5\x89~ |\x87" "C \x82R\x90\xfc\xa5\x89~ |");
                    jw_ui_text(v, 73, 1, 7, 0, "[BS]\x91O\x8d\x80");
                } else {
                    ...
                    jw_ui_text(v, 8, 1, 7, 0,
                               ...
                               : i == 55 ? " \x82R\x90\xfc\xa5\x89~\x82\xcc\x90\xda\x89~    \x91\xe6\x82Q\x82\xcc\x90\xfc\xa5\x89~\x82\xf0\x83}\x83" "E\x83X\x8ew\x8e\xa6 " : " \x82R\x90\xfc\xa5\x89~\x82\xcc\x90\xda\x89~      \x91\xe6\x82R\x82\xcc\x90\xfc\xa5\x89~\x82\xf0\x83}\x83" "E\x83X\x8ew\x8e\xa6 ");
                    jw_ui_text(v, 73, 1, 7, 0, "[BS]\x91O\x8d\x80");
                }
            }
            /* ②接円（半径と２条件）の道。 */
